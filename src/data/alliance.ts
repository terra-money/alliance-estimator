...
export const allianceFields: AllianceField[] = [
  {
    ...
    secondaryLabel: "The Yield of the LSD. Set to 0 if not an LSD",
    input: true,
    inputSuffix: "%",
  },
  {
  ...
  },
  {
    ...
    secondaryLabel: "Use when whitelisting this Alliance asset through Governance",
    input: false,
    name: "takeRate",
  ...
  },
  {
    ...
    secondaryLabel: "Amount of this asset redistributed to the reward pool after 1 year of the take rate",
    input: false,
    advanced: true,
  },
  {
  ...
  },
  {
    ...
    secondaryLabel: "Value of this asset redistributed to the reward pool after 1 year of the take rate tax, including LSD appreciation",
    input: false,
    format: (value) => currencyFormat(value),
  },
  {
